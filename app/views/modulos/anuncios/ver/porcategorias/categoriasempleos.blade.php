	  	 ...
	  	 <div class="col-xs-12 col-md-6">
            ...
            <div class="blockquote-box blockquote-info clearfix">
                ...
                <h4 class="enlace-categoria">
                	<a href="{{ route('empleos.categoria.n',[$categoria->id]) }}" title="">{{$categoria->categoria}}
					</a>
                	
                </h4>
	                <p class="enlacessubcategorias">
		                @foreach ($categoria->subcategorias as $subcategoria)
			            	<a href="{{ route('empleos.subcategoria.n',[ $categoria->id, $subcategoria->id ]) }}" title="">{{$subcategoria->subcategoria}} </a>  -  
