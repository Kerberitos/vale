...
<div class="text-center">
    <h3>Anuncios sobre servicios subcategoría {{strtolower($subcategoria->subcategoria)}}</h3>
</div>
<div class="row">
    <div class="col-xs-12  col-sm-12 col-md-12 cabeza">
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('servicios.categoria.n',[$categoria->id]) }}">{{$categoria->categoria}}</a></li>
