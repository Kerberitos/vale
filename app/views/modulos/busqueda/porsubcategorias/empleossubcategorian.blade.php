...
<div class="text-center">
    <h3>Anuncios sobre empleos subcategoría {{strtolower($subcategoria->subcategoria)}}</h3>
</div>
<div class="row">
    <div class="col-xs-12  col-sm-12 col-md-12 cabeza">
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('empleos.categoria.n',[$categoria->id]) }}">{{$categoria->categoria}}</a></li>
