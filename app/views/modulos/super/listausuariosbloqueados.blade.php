    ...
    <div class="row">
    	@if (Session::has('status_error'))
   		...
   		@endif
			...
			<div>
				<form action="{{route('lista.usuarios.bloqueados')}}" method="GET" role="form">
				<div class="col-xs-12">
				 	<a href="{{route('lista.usuarios.bloqueados')}}" class="btn btn-success btn-sm btn-recargar pull-right" title="Recargar todos"><span class="icon-repeat" > </span> </a>
