        ...
        <div class="panel panel-danger">
            <div class="panel-heading">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="panel-title" id="contactLabel"><span class="icon-cancel"></span> Comentario realmente incumple normas</h4>
            </div>
                ...
                <div class="modal-body" style="padding: 5px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <p>{{Auth::user()->nombres}}, ¿has constatado si el comentario denunciado realmente incumple alguna norma de miradita? y de ser así deseas bloquearlo, entonces  presiona bloquear</p>
                        </div>
                    </div>
                </div>  
